...
// routing in production. The defaults are single-origin paths, which is also
// how local single-origin dev works (scripts/dev-web.mjs serves every zone
// behind one origin on :3000, so the shared sessionStorage handoff holds).
